function I = ReconstructFingerprint(minu_file,param)
% ReconstructFingerprint_Smooth
%
% Jianjiang Feng
% 2009-04
% 2009-04-23, utilize singularity
% 2010-04, Interface changed
...
% -- add in 2024.11 by guan, cause VeriFinger version changed
MINU(:,3) = 360 - MINU(:,3); 
% -- end
